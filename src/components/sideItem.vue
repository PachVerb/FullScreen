<template>
  <transition :name="`go-in-item-${transitionType}`">
    <div
      class="side-item"
      :style="{ height }"
      v-show="currentSys == thisCrrentSys"
    >
      ...
      <div v-show="!loading" class="border">
        <img src="../assets/img/side-item-border.png" alt="" />
      </div>
    </div>
  </transition>
</template>
...
.go-in-item-left-enter-active,
.go-in-item-left-leave-active {
...
.go-in-item-right-enter-active,
.go-in-item-right-leave-active {
