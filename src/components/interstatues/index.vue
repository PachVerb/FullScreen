      ...
      <div slot="left" style="height: 100%;">
            ...
            <div class="violation-detail-table">
              ...
              <div class="ab-list patrol">
                ...
                >
                  <div
                    class="ab-item-wrap"
                    v-for="item in abDetailList"
                    :key="item.id"
                  >
                    <div class="ab-item">
                      <div
                        class="table-item ab-item-name"
                        :style="{ width: tableHead[0].width }"
                      >
                        {{ item.name }}
                      </div>
                      <div
                        class="table-item"
                        :style="{ width: tableHead[1].width }"
                        :title="item.reason"
                      >
                        {{ item.reason }}
                      </div>
        ...
        >
          <div slot="headRight" class="deviceDetail">
            <div class="checkBox">
              <div
                :class="trendKey == 0 ? 'btn checked' : 'btn'"
                @click="getTrendAnalyData(0)"
              >
                近一周
              </div>
              <div
                :class="trendKey == 1 ? 'btn checked' : 'btn'"
                @click="getTrendAnalyData(1)"
              >
                近一月
              </div>
              <div
                :class="trendKey == 2 ? 'btn checked' : 'btn'"
                @click="getTrendAnalyData(2)"
              >
                近一年
              </div>
            </div>
        ...
        >
          ...
          >
            ...
            <div class="listBox">
              <div
                class="content"
                @mouseenter="dormScrollStop"
                @mouseleave="dormScrollStart"
              >
        ...
        >
          ...
          >
            ...
            <div class="listBox">
              <div
                class="content"
                @mouseenter="webScrollStop"
                @mouseleave="webScrollStart"
              >
...
export default {
        ...
        if (this.currentSysModule) {
          ...
          switch (this.currentSysModule) {
            case "networkEquipment":
              ...
              this.createInterStatusEqMraker(
                "mesList",
                "interStatusEqMarkerList"
              );
              this.apList = [
                {
                  buildingId: "18780",
  ...
  methods: {
    ...
    dormScrollStart() {
      ...
      this.dormList.length &&
        this.$nextTick(() => {
          this.dormScrollStop();
          let scrollBox = document.querySelector(
            ".serverSecuritytotal .listBox"
          );
          let content = document.querySelector(
            ".serverSecuritytotal .listBox .content"
          );
          let items = document.querySelectorAll(
            ".serverSecuritytotal .listBox .content .row"
          );
    ...
    dormScrollStop() {
      ...
      document.querySelector(".serverSecuritytotal .listBox") &&
        (document.querySelector(".serverSecuritytotal .listBox").className =
          "listBox"); //显示滚动条
    },
    //开始自动滚动
    abScrollStart() {
      console.log("abScrollStart11");
      this.abDetailList.length &&
        this.dormList.length &&
        this.$nextTick(() => {
          console.log("jinru");
          this.abScrollStop();
          ...
          //检查滚动距离是否过短
          console.log(
            content.clientHeight - scrollBox.clientHeight < itemH,
            "5555",
    ...
    setPopup(item) {
      ...
      popupDom.innerHTML = `
            ...
            item.cate == 0
              ...
              : "interStatus-popup-head interStatus-popup-abhead"
          }">连接人数：251人</div>
					<div class="interStatus-popup-body">
						<div><span>设备状态：</span><span class="${
              item.cate == 0
                ? "interStatus-popup-normal"
                : "interStatus-popup-ab"
            }">${item.cate == 0 ? "正常" : "异常"}</span></div>
      ...
      this.popupMarker = new creeper.Marker({ element: popupDom })
    ...
    getDormStatus() {
      this.dormList = [
        {
          date: "09-01 00:00:00",
          ipaddress: "122.168.6.14",
          targetip: "211.234.145.255",
          type: "web弱命令",
        },
        {
          date: "09-01 00:00:00",
    ...
    getWebsafedate() {
      this.webSafedate = [
        {
          ranking: "01",
          domainName: "192.168.6.14",
          type: "恶意访问接口",
          numberAlarms: "15",
        },
        {
          ranking: "02",
          domainName: "122.168.6.14",
          type: "恶意访问接口",
          numberAlarms: "156",
        },
        {
    ...
    //开始自动滚动
    webScrollStart() {
      this.webSafedate.length &&
        this.$nextTick(() => {
          this.webScrollStop();
          let scrollBox = document.querySelector(
            ".websiteSecurityanalysis .listBox"
          );
          let content = document.querySelector(
            ".websiteSecurityanalysis .listBox .content"
          );
          let items = document.querySelectorAll(
            ".websiteSecurityanalysis .listBox .content .row"
          );
          let itemH = items[0].clientHeight;
          let nexTop =
            Math.ceil(scrollBox.clientHeight / itemH) * itemH -
    ...
    webScrollStop() {
      ...
      document.querySelector(".websiteSecurityanalysis .listBox") &&
        (document.querySelector(".websiteSecurityanalysis .listBox").className =
          "listBox"); //显示滚动条
    },
    renderrightbar() {
    ...
    renderrightpie() {
      ...
      webSecuritytotalpieChartDom = document.getElementById(
        "webSecuritytotalpie"
      );
    ...
    randerBar() {
      ...
      networkdevicetotalChartDom = document.getElementById(
        "networkdevicetotal"
      );
    ...
    getTrendAnalyData(index) {
      ...
      if (index == 0) {
        charts = {
          ...
          value: [[251, 152, 103, 334, 95, 236, 217]],
        };
      } else if (index == 1) {
        charts = {
          unit: "",
          ...
          value: [[151, 352, 303, 534, 95, 236, 217, 328, 159, 151, 31]],
        };
      } else if (index == 2) {
        charts = {
          unit: "",
          ...
          value: [[451, 352, 303, 534, 95, 236, 217, 328, 159, 151, 231, 392]],
        };
      }
