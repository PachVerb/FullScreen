	...
	<div>
		<sideTran thisCrrentSys="dormitory" widthL="30%">
			<div slot="left" class="left">
				...
				<div class="homestatues">
					...
					<div class="homestatuesright">
						<div class="leftstatuesbox" v-for="(item,index) in homestaueslist">
							<div>
								<p style="display: inline-block;color: #00F5FF;font-weight: bolder;">{{item.peoplenum}}
				...
				<div class="border" style="position: relative;top: 50px;"><img src="../assets/img/side-item-border.png"
						alt=""></div>
				<div class="side-item-title" style="width: 30%;margin-top: 60px;">
					<img src="../assets/img/side-item-title.png" alt="">
					<span>宿舍利用情况</span>
				</div>
...
<script>
	...
	export default {
		...
		methods: {
			randerBar() {
				let myCircle = this.$echarts.init(document.getElementById('returntoBed'))
				let list = [{
					name: '一号宿舍楼',
					value: 36
				}, {
		...
		mounted() {
			...
			console.log(this.$echarts,"5555",this.$ref.returntoBed)
