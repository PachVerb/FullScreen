...
<div class="login">
    <div class="login_box">
        <div style="width:100%;height:20%;line-height:0.5rem;font-size:0.1rem;text-align: center;">用户登录</div>
        <div class="login_name">
            <img src="../assets/img/user_name.png" alt="">
             <label for="" style="line-height:0.25rem;margin-left:5%;width:18%">用户名</label>
             <input type="text" class="username" v-model="username" placeholder="请输入用户名" >
        </div>
        <div class="login_name">
            <img src="../assets/img/password.png" alt="">
             <label for="" style="line-height:0.25rem;margin-left:5%;width:18%">密码</label>
             <input type="password" class="username"  v-model="passWord" placeholder="请输入密码" @keyup.enter="log()">
        </div>
        <div class="pass">
            <van-checkbox v-model="checked" shape="square" icon-size="16px">记住密码</van-checkbox>
        </div>
